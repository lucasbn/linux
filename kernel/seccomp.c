...
seccomp_func_proto(enum bpf_func_id func_id, const struct bpf_prog *prog)
{
	...
	// TODO: Confusion here: are we meant to use bpf_tracing_func_proto()? It was made
	// static in a later kernel version. Maybe tracing_prog_func_proto() should
	// be used instead? But they do different things. Unsure.
