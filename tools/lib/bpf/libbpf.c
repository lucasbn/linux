...
static const char * const attach_type_name[] = {
	...
	[BPF_CGROUP_SYSCALL_SOCKET] = "cgroup_syscall_socket",
	[BPF_CGROUP_SYSCALL_SOCKET_EXIT] = "cgroup_syscall_socket_exit",
	[BPF_CGROUP_SYSCALL_SENDMSG] = "cgroup_syscall_sendmsg",
	[BPF_CGROUP_SYSCALL_SENDTO] = "cgroup_syscall_sendto",
	[BPF_CGROUP_SYSCALL_RECVMSG] = "cgroup_syscall_recvmsg",
	[BPF_CGROUP_SYSCALL_RECVMSG_EXIT] = "cgroup_syscall_recvmsg_exit",
	[BPF_CGROUP_SYSCALL_BIND] = "cgroup_syscall_bind",
	[BPF_CGROUP_SYSCALL_SETSOCKOPT] = "cgroup_syscall_setsockopt",
	[BPF_CGROUP_SYSCALL_GETSOCKNAME] = "cgroup_syscall_getsockname",
	[BPF_CGROUP_SYSCALL_CONNECT] = "cgroup_syscall_connect",
	[BPF_CGROUP_SYSCALL_ACCEPT_EXIT] = "cgroup_syscall_accept_exit",
	[BPF_CGROUP_SYSCALL_UNAME] = "cgroup_syscall_uname",
...
static const char * const prog_type_name[] = {
	...
	[BPF_PROG_TYPE_CGROUP_SYSCALL]  = "cgroup_syscall",
};
...
static const struct bpf_sec_def section_defs[] = {
	...
	SEC_DEF("cgroup/syscall_socket", CGROUP_SYSCALL, BPF_CGROUP_SYSCALL_SOCKET, SEC_ATTACHABLE),
	SEC_DEF("cgroup/syscall_socket_exit", CGROUP_SYSCALL, BPF_CGROUP_SYSCALL_SOCKET_EXIT, SEC_ATTACHABLE),
	SEC_DEF("cgroup/syscall_sendmsg", CGROUP_SYSCALL, BPF_CGROUP_SYSCALL_SENDMSG, SEC_ATTACHABLE),
	SEC_DEF("cgroup/syscall_sendto", CGROUP_SYSCALL, BPF_CGROUP_SYSCALL_SENDTO, SEC_ATTACHABLE),
	SEC_DEF("cgroup/syscall_recvmsg", CGROUP_SYSCALL, BPF_CGROUP_SYSCALL_RECVMSG, SEC_ATTACHABLE),
	SEC_DEF("cgroup/syscall_recvmsg_exit", CGROUP_SYSCALL, BPF_CGROUP_SYSCALL_RECVMSG_EXIT, SEC_ATTACHABLE),
	SEC_DEF("cgroup/syscall_bind", CGROUP_SYSCALL, BPF_CGROUP_SYSCALL_BIND, SEC_ATTACHABLE),
	SEC_DEF("cgroup/syscall_setsockopt", CGROUP_SYSCALL, BPF_CGROUP_SYSCALL_SETSOCKOPT, SEC_ATTACHABLE),
	SEC_DEF("cgroup/syscall_getsockname", CGROUP_SYSCALL, BPF_CGROUP_SYSCALL_GETSOCKNAME, SEC_ATTACHABLE),
	SEC_DEF("cgroup/syscall_connect", CGROUP_SYSCALL, BPF_CGROUP_SYSCALL_CONNECT, SEC_ATTACHABLE),
	SEC_DEF("cgroup/syscall_accept_exit", CGROUP_SYSCALL, BPF_CGROUP_SYSCALL_ACCEPT_EXIT, SEC_ATTACHABLE),
	SEC_DEF("cgroup/syscall_uname", CGROUP_SYSCALL, BPF_CGROUP_SYSCALL_UNAME, SEC_ATTACHABLE),
