...
static const char * const attach_type_name[] = {
	...
	[BPF_CGROUP_NETLINK_GETLINK]		= "cgroup_netlink_getlink",
...
static const char * const prog_type_name[] = {
	...
	[BPF_PROG_TYPE_CGROUP_NETLINK]		= "netlink",
};
...
static const struct bpf_sec_def section_defs[] = {
	...
	SEC_DEF("cgroup/netlink_getlink",		CGROUP_NETLINK, BPF_CGROUP_NETLINK_GETLINK, SEC_ATTACHABLE),
